...
SECRET_KEY = 'django-insecure-6@88&6y4k*niqyuxe43$ex#ecetfa^w6yt8vr)+m&k+j^@pq&g'
...
STATIC_URL = '/static/'
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'static'),  # Static files in the project
# ]


STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'inventory/static'),  # Inside your `inventory` app
]
